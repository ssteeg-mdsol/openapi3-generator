...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<prawn-templates>.freeze, [">= 0.0.3", "<= 0.1.1"])
      s.add_runtime_dependency(%q<prawn-svg>.freeze, [">= 0.21.0", "< 0.28.0"])
      ...
      s.add_dependency(%q<prawn-templates>.freeze, [">= 0.0.3", "<= 0.1.1"])
      s.add_dependency(%q<prawn-svg>.freeze, [">= 0.21.0", "< 0.28.0"])
